...
public class UserDTO extends GenericDTO {
    ...
    public void setUpdateDate(Date updateDate) {
        super.setUpdateDate(updateDate); //To change body of generated methods, choose Tools | Templates.
    }

    @Override
    public Date getUpdateDate() {
        return super.getUpdateDate(); //To change body of generated methods, choose Tools | Templates.
    }
